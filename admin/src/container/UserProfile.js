...
class UserProfile extends Component{
  ...
  sendprofile = () => {
    ...
    axios.put('http://localhost:100/user/updateadmin/'+ this.state.user._id, data,this.state.config).then(function(){
  ...
  sendprofilepic = () => {
    ...
    axios.put('http://localhost:100/updateAdminProfile/'+ this.state.user._id, formdata,this.state.config).then(function(){
      window.location.reload();
    })
  }
     render(){
                            ...
                            <div class="row mt-5 align-items-center">
                                <div class="col-md-3 text-center mb-5">
                                    <div class="avatar avatar-xl">
                                        <img src={"http://localhost:100/images/" + this.state.user.image} alt="..." class="avatar-img rounded-circle" style ={{width:'100px',height:'100px'}} />
                                    </div>
                                </div>
                                <div class="col">
